...
//gcc -Wall -O2 -I include/ -o get_samples_rand test/bench/get_samples_rand.c lib/libslow5.a -lm -lz -lzstd -lpthread  -fopenmp
...
int main(int argc, char *argv[]) {
    ...
    if(argc != 5) {
        fprintf(stderr, "Usage: %s in_file.blow5 inread_id.tsv num_thread batch_size\n", argv[0]);
        return EXIT_FAILURE;
    }
